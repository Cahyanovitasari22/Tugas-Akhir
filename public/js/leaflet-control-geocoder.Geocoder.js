            ...
            Util.getJSON(url, params, function(data) {
                ...
                if (data.response.view && data.response.view.length) {
                    for (var i = 0; i <= data.response.view[0].result.length - 1; i++) {
                        ...
                        latLngBounds = L.latLngBounds(L.latLng(loc.mapView.topRight.latitude, loc.mapView.topRight.longitude), L.latLng(loc.mapView.bottomRight.latitude, loc.mapView.bottomRight.longitude));
                        results[i] = {
