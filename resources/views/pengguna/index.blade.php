<x-app>
    <div class="card">
        <div class="card-header">
            ...
            <a href="{{url('pengguna/create')}}" class="btn btn-secondary float-right">
            ...
            <table class="table table-bordered" >
                ...
                @foreach ($list_user as $user)
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                <a href="{{ url('pengguna', $user->id) }}" class="btn btn-info">
                                    <i class="fas fa-info"></i>
                                </a>
                                <a href="{{ url('pengguna', $user->id) }}/edit" class="btn btn-warning">
